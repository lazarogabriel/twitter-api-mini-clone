...
namespace twitter.api.domain.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new <see cref="InvalidParameterException"/>.
        /// </summary>
        ...
        public InvalidParameterException(string message, [CallerArgumentExpression("message")] string type = null, params object[] values)
